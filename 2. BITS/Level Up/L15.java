public class L15 {
   ...
   public static int divide(int dividend, int divisor) {
      ...
      while (dvd >= dvs) {
         ...
         // Finding the largest multiple of divisor that can be subtracted from dividend
         // without making it negative
         while (dvd >= (temp << 1)) {
            temp <<= 1; // Doubling the value of temp
            multiple <<= 1; // Doubling the value of multiple to keep track of how many times temp was
                            // doubled
         }
